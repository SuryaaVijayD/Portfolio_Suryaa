...
function About() {
    ...
    return (
        <div className='overflow-hidden text-white flex flex-col md:flex-row justify-between py-8 px-8 md:px-14'>
            <div className='flex flex-col relative ' data-aos="fade-right">
            ...
            <div className='md:max-w-[500px]' data-aos="fade-left">
